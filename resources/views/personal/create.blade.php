    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('personal.store') }}">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="celular" aria-describedby="emailHelp" name="celular"
                    min="100000000" max="999999999" value="{{ $postulante->celular }}">
                @error('celular')
                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                @enderror
            </div>
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="gradoEstudios" aria-describedby="emailHelp"
                    name="gradoEstudios" value="{{ $postulante->gradoEstudios }}">
                @error('gradoEstudios')
                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                @enderror
            </div>
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="centroEstudios" aria-describedby="emailHelp"
                    name="centroEstudios" value="{{ $postulante->centroEstudios }}">
            ...
            <div class="mb-3">Fecha Ingreso:</label>
                <input type="date" class="form-control @error('fechaIng') is-invalid  @enderror" id="fechaIng"
                    aria-describedby="emailHelp" name="fechaIng">
                @error('fechaIng')
                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                @enderror
            </div>
            <div class="mb-3">
                ...
                <input type="number" class="form-control @error('sueldo') is-invalid  @enderror" id="sueldo"
                    aria-describedby="emailHelp" name="sueldo">
                @error('sueldo')
                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                @enderror
            </div>
